 ...
 * song finishes. To override this, set a custom {@link SimpleQueuedMediaPlayer.PlaybackEventListener}
 ...
 */
public class SimpleQueuedMediaPlayer implements Player.OnPreparedListener,
        Player.OnCompletionListener, Player.OnErrorListener, QueuedMediaPlayer {
     ...
     */
    public SimpleQueuedMediaPlayer(Context context) {
