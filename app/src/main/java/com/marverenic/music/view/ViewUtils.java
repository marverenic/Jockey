...
public final class ViewUtils {
    ...
    public static int getNumberOfGridColumns(Context context) {
        ...
        final short globalPadding =
                (short) (context.getResources().getDimension(R.dimen.global_padding) / density);
        final short minWidth =
                (short) (context.getResources().getDimension(R.dimen.grid_width) / density);
        final short gridPadding =
                (short) (context.getResources().getDimension(R.dimen.grid_margin) / density);
